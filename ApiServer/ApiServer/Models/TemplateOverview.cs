...
public record Model_TemplateRow(Guid RowId, Guid TemplateId, int SortOrder, bool CanWrapCells, bool CanRepeat, bool HideOnNoInput, Model_TemplateCell[] Cells)
{
...
public record Model_DetailedTemplate(Guid ID, string Name, string? Description, Model_TemplateRow[] TemplateRows);
