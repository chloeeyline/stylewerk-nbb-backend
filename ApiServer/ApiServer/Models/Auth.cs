...
/// <param name="Gender">gender of the current user. Can be male, female or non binary</param>
...
/// </summary>
/// <param name="Token">status token on password reset should be "PasswordReset"</param>
/// <param name="Password">new password</param>
public record Model_ResetPassword(string Token, string Password);

/// <summary>
/// Used to validate one of these options: username, password or email
/// </summary>
...
/// </summary>
/// <param name="AccessToken">access token as string. Used to identifiy the user and granting access to the application on login</param>
/// <param name="RefreshToken">refresh token as string to keep the users login</param>
...
/// <summary>
/// Used to get or set the refresh or access token
/// </summary>
/// <param name="Token">refresh or access token as string</param>
/// <param name="ExpireTime">expire time of the token as long</param>
