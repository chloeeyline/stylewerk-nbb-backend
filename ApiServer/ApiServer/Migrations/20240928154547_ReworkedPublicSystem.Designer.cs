...
namespace StyleWerk.NBB.Migrations
{
    ...
    [Migration("20240928154547_ReworkedPublicSystem")]
    partial class ReworkedPublicSystem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StyleWerk.NBB.Database.Share.Share_GroupUser", b =>
                {
                    ...
                    b.HasOne("StyleWerk.NBB.Database.User.User_Login", "O_WhoShared")
                        .WithMany()
                        .HasForeignKey("O_WhoSharedID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
